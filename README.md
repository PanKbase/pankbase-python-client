...
The Python client is autogenerated based on this [PanKBase OpenAPI specification](https://pankbase-db.github.io/pankbase-client-openapi-spec/), which exposes `search`, `collection`, and other read endpoints from the [PanKbase Data Portal](https://github.com/PanKbase/pankbase-python-client.git).
...
```sh
$ git clone https://github.com/PanKbase-DB/pankbase-python-client
$ cd pankbase-python-client
$ pip install -e .
```
...
config = Configuration(
    access_key = os.environ["PKB_ACCESS_KEY"],
    secret_access_key = os.environ["PKB_SECRET_ACCESS_KEY"]
)
...
*IgvfApi* | [**search**](docs/IgvfApi.md#search) | **GET** /search | Search for items on the PKB Data Portal.
...
*IgvfApi* | [**modifications**](docs/IgvfApi.md#modifications) | **GET** /modifications/@@listing | List items in the Modification collection.
...
## Documentation for Models
 ...
 - [ModificationResults](docs/ModificationResults.md)
