...
The Python client is autogenerated based on this [PanKBase OpenAPI specification](https://pankbase-db.github.io/pankbase-client-openapi-spec/), which exposes `search`, `collection`, and other read endpoints from the [PanKbase Data Portal](https://data.pankbase.org).
...
```sh
$ git clone https://github.com/PanKbase/pankbase-python-client.git
