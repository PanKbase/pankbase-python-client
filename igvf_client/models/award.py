...
class Award(BaseModel):
    ...
    def project_validate_enum(cls, value):
        ...
        if value not in set(['community', 'ENCODE', 'PanKbase', 'IGVF']):
            raise ValueError("must be one of enum values ('community', 'ENCODE', 'PanKbase', 'IGVF')")
        return value
    ...
    def viewing_group_validate_enum(cls, value):
        ...
        if value not in set(['community', 'PanKbase', 'IGVF']):
            raise ValueError("must be one of enum values ('community', 'PanKbase', 'IGVF')")
        return value
