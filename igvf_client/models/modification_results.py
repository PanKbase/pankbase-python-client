...
class ModificationResults(BaseModel):
    """
    ModificationResults
    """ # noqa: E501
    graph: Optional[List[Modification]] = Field(default=None, alias="@graph")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "@graph": [Modification.from_dict(_item) for _item in obj["@graph"]] if obj.get("@graph") is not None else None,
            "@id": obj.get("@id"),
            "@type": obj.get("@type"),
            "total": obj.get("total"),
